...
public class JooqChatLinkServiceTest extends IntegrationEnvironment {

    private final ChatLinkService service;
    ...
    @Autowired
    public JooqChatLinkServiceTest(
    ...
    @AfterEach
    public void clearDb() {
        context.delete(TG_CHAT_LINK).execute();
        context.delete(TG_CHAT).execute();
