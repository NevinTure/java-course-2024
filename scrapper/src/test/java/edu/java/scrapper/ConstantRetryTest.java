...
import edu.java.scrapper.configuration.ConstantRetryConfig;
...
public class ConstantRetryTest extends IntegrationEnvironment {
    ...
    public void testMethodWithRetry() {
        ...
        Mockito.verify(botClient, times(ConstantRetryConfig.MAX_ATTEMPTS)).post();
    }
}
